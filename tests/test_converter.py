        ...
        cases = [
            ...
            },
            {
                ...
                "params": {
                    "old_nodes": [
                        TextNode(
                            "This is text with a **bold word** here and a **bold word** there",
                            "text",
                        )
                    ],
                    "delimiter": "**",
    ...
    def test_extract_markdown_images_and_links(self):
        cases = [
            ...
            },
            {
                ...
                "want": [
                    ("alt text", "https://www.boot.dev"),
                    ("another alt text", "https://www.boot.dev"),
                ],
            },
            {
            ...
            },
            {
                ...
                "want": [
                    ("link text", "https://www.boot.dev"),
                    ("another link text", "https://www.boot.dev"),
                ],
            },
            {
        ...
        cases = [
            ...
            },
            {
                ...
                "params": {
                    "old_nodes": [
                        TextNode(
                            f"This is text with a {rick_roll} and {obi_wan}", "text"
                        )
                    ],
                    "extract_func": extract_markdown_images,
                    "md_format": "![{}]({})",
            ...
            },
            {
                ...
                "params": {
                    "old_nodes": [
                        TextNode(
                            "This is text with a [link](https://www.boot.dev)", "text"
                        )
                    ],
