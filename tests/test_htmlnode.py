...
class TestLeafNode(unittest.TestCase):
    def test_to_html(self):
        cases = [
            ...
            {
                "params": {"tag": "b", "value": "Bolded text"},
...
class TestParentNode(unittest.TestCase):
    def test_to_html(self):
        cases = [
            ...
            },
            {
                "params": {
                    "tag": "a",
                    "children": [LeafNode("This is a link", None)],
                    "props": {"href": "https://www.boot.dev"},
                },
                "expected": '<a href="https://www.boot.dev">This is a link</a>',
            },
    ...
    def test_to_html_raises_value_error(self):
        cases = [
            {"tag": "div", "children": None},
            {"tag": "div", "children": []},
            {"tag": None, "children": [LeafNode("This is a div node", "p")]},
            {"tag": "div", "children": [ParentNode([], "div")]},
            {
                "tag": "div",
                "children": [
                    ParentNode([LeafNode("This is a child div node", "p")], None)
                ],
            },
        ]
